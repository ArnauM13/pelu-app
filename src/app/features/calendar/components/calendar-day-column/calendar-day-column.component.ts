...
import {
  ...
  AppointmentSlotData,
} from '../../slots/appointment-slot.component';
import {
  CalendarDayHeaderComponent,
  DayHeaderData,
} from '../calendar-day-header/calendar-day-header.component';
import {
...
@Component({
  ...
  template: `
    <div class="day-column" [class.past]="data().isPast" [class.disabled]="data().isDisabled">
      <!-- Day Header -->
      <pelu-calendar-day-header [data]="dayHeaderData()"> </pelu-calendar-day-header>
